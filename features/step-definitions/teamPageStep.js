...
import teamPage, { administratorsMembersApi, availableSeatsApi, configuredMembersApi, inactiveMembersApi, invitedMembersApi, notConfiguredMembersApi, suspendedMembersApi, undeliverableMembersApi } from '../pageobjects/teamPage.js';
...
Then(/^Confirm not configured for voice is equal to data from API$/, async () => {
    await browser.waitUntil(async () => {
...
Then(/^Confirm undeliverable invitations is equal to data from API$/, async () => {
    await browser.waitUntil(async () => {
