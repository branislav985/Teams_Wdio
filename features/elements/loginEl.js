export default class LoginPageSelectors {
  ...
  CHOSE_CHANGE_PASS_BUTTON = $(
    'button[data-testid="resetPasswordSubmitButton"]',
  );
  ...
  INPUT_CURRENT_PASSWORD = $(
    'div[data-password-input="currentPassword"]>input',
  );
  INPUT_NEW_PASSWORD = $('div[data-password-input="newPassword"]>input');
  CONFIRM_CHANGE_PASSWORD = $('button[title="Update Password"]');
  CHANGE_PASS_CONFIRM_MESSAGE = $(
    'div[data-testid="passwordChangeStatusSuccess"]',
  );
